package speeddev.info.skywars.object;
...
import speeddev.info.skywars.Rollback;
import speeddev.info.skywars.Skywars;
import speeddev.info.skywars.data.DataHandler;
import speeddev.info.skywars.tasks.GameCountdownTask;
...
public class Game {
    ...
    public Game(String gameName) {
        ...
        Rollback.getRollBack().rollback(fileConfiguration.getString("games." + gameName + ".worldName"));
